...
insert into product values ('1071989f-888e-4e3b-985d-6d9151a24619', 'product1', 'descProduct1', null, 'b49394f3-0f15-4f0c-ab4b-276cd736c67b', 'IN_STOCK') on conflict do nothing;
insert into product values ('213f4e74-2ffe-4b5d-ac67-a3a56c1bdcf6', 'product2', 'descProduct2', null, 'b49394f3-0f15-4f0c-ab4b-276cd736c67b', 'IN_STOCK') on conflict do nothing;
insert into product values ('a6a8eaba-dbde-488f-989b-7ed81b885c2d', 'product3', 'descProduct3', null, 'b49394f3-0f15-4f0c-ab4b-276cd736c67b', 'IN_STOCK') on conflict do nothing;
insert into product values ('fc496d63-a931-49ff-ba44-2f8f482cc79b', 'product4', 'descProduct4', null, 'b49394f3-0f15-4f0c-ab4b-276cd736c67b', 'IN_STOCK') on conflict do nothing;
insert into product values ('9af3781e-bd51-4912-960d-c0a1cb94e90d', 'product5', 'descProduct5', null, 'b49394f3-0f15-4f0c-ab4b-276cd736c67b', 'IN_STOCK') on conflict do nothing;
insert into product values ('ab65501b-6b15-4bdc-a660-fac35eda39d9', 'product6', 'descProduct6', null, 'b49394f3-0f15-4f0c-ab4b-276cd736c67b', 'IN_STOCK') on conflict do nothing;
insert into product values ('e523a867-6313-48f1-ab8f-6135fecf4b72', 'product7', 'descProduct7', null, 'b49394f3-0f15-4f0c-ab4b-276cd736c67b', 'IN_STOCK') on conflict do nothing;
